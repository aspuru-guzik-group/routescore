...
p2 = ax3D.scatter3D(subSpace['log_RS'], subSpace['overlap'], subSpace['log_kR'], c=cm(subSpace['fluo_peak_1']), marker='o')
# max1 = ax3D.scatter3D(maxPkScr['log_RS'], maxPkScr['overlap'], maxPkScr['log_kR'], c='red', marker='o', alpha=1, label='Best peak score')
# min2 = ax3D.scatter3D(maxCost['log_RS'], maxCost['overlap'], maxCost['log_kR'], c='purple', marker='o', alpha=1, label='Best RouteScore')
# min3 = ax3D.scatter3D(maxOvlp['log_RS'], maxOvlp['overlap'], maxOvlp['log_kR'], c='orange', marker='o', alpha=1, label='Best spectral overlap')
# max4 = ax3D.scatter3D(maxRate['log_RS'], maxRate['overlap'], maxRate['log_kR'], c='blue', marker='o', alpha=1, label='Best fluorescence rate')
