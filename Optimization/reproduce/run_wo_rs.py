...
REPEATS = 50                  # number of independent runs on this no
...
for seed in RANDOM_SEEDS:
    ...
    if os.path.isfile(f'runs_wo_rs/gryf_naive_{seed}.pkl') is True:
        with open(f'runs_wo_rs/gryf_naive_{seed}.pkl', 'rb') as content:
    ...
    for iter in range(BUDGET):
        ...
        pickle.dump(
            observations,
            open(f'runs_wo_rs/gryf_naive_{seed}.pkl', 'wb')
        )
